...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'hexo', // 主题， 支持 ['next','hexo',"fukasawa','medium','example','matery','nobelium','simeple'] 
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Pixiv插画特辑', // 昵称
  BIO: process.env.NEXT_PUBLIC_BIO || 'Pixiv插画特辑分享', // 简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.pixiv.net', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '购物,娱乐,插画,pixiv,画师', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'www.pixiv.net', // 微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'www.pixiv.net', // twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'www.pixiv.net', // github个人主页 例如 
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'www.pixiv.net', // telegram 地址 例如
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // linkedIn 首页

  // 网站字体
  FONT_STYLE: process.env.NEXT_PUBLIC_FONT_STYLE || 'font-sans', // ['font-serif','font-sans'] 两种可选，分别是衬线和无衬线
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://pixiv-pictures.vercel.app/', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)
